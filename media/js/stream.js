Stream = new (function() {
	...
	function _post() {
		...
		$("#stream-recent").prepend(
			Templates.stream.render({stream:{text: text, published: new Date().toString()}})
		);
	}
})();
...
Template = function(html) {
	...
	this.render = function(context) {
		return this.html.replace(/\{\{ ([^}]+) \}\}/g, function(tag, names) {
			var cont = context;
